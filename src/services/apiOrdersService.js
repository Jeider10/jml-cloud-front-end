...
export const cerrarOrdenPorCliente = (identificacionCliente, valorRecibido) =>
    apiOrders.patch(`/ordenes-ventas/cliente/orden/cerrar/${identificacionCliente}`, null, {
...
export const buscarOrdenesPorFechaCreacion = (fechaInicio, fechaFin) => apiOrders.get('/ordenes-ventas/fechaCreacion', { params: { fechaInicio, fechaFin } })

// 🔹 Búsquedas individuales para Historial de Ventas (desde backend)
export const buscarOrdenesPorCliente = (cliente) => apiOrders.get('/ordenes-ventas/buscar/cliente', { params: { cliente } })
export const buscarOrdenesPorIdCliente = (idCliente) => apiOrders.get('/ordenes-ventas/buscar/idCliente', { params: { idCliente } })
export const buscarOrdenesPorVendedor = (vendedor) => apiOrders.get('/ordenes-ventas/buscar/vendedor', { params: { vendedor } })
export const buscarOrdenesPorIdVendedor = (idVendedor) => apiOrders.get('/ordenes-ventas/buscar/idVendedor', { params: { idVendedor } })
export const buscarOrdenesPorFactura = (factura) => apiOrders.get('/ordenes-ventas/buscar/factura', { params: { factura } })
export const buscarOrdenesPorProducto = (producto) => apiOrders.get('/ordenes-ventas/buscar/producto', { params: { producto } })
export const buscarOrdenesPorEstado = (estado) => apiOrders.get('/ordenes-ventas/list/estado', { params: { estado } })
