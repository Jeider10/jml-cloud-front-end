...
// =======================
export const apiAuthentication = createAxiosWithAuth(
...
export const login = async (usuario, password) => {
  const response = await apiAuthentication.post("/authentication/login", {
    usuario,
    password,
  });
...
export const logoutBackend = async () => {
  ...
  try {
    await apiAuthentication.post("/authentication/logout", {
...
export const registerUser = (user) =>
  apiAuthentication.post("/user/register", user);
