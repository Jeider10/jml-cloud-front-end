...
// Búsqueda por marca
export const buscarProductoPorMarca = (marca) => apiProducts.get('/productos/marca', { params: { marca } })

// Búsqueda por descripción
export const buscarProductoPorDescripcion = (descripcion) => apiProducts.get('/productos/descripcion', { params: { descripcion } })

// Búsqueda por referencia
export const buscarProductoPorReferencia = (referencia) => apiProducts.get('/productos/referencia', { params: { referencia } })

// Búsqueda por unidad de medida
export const buscarProductoPorUnidadDeMedida = (unidadMedida) => apiProducts.get('/productos/unidadMedida', { params: { unidadMedida } })
