<!-- src/components/configuracion/usuario/ConfiguracionActualizarUsuarioView.vue -->
...
export default {
  ...
  async mounted() {
    console.log('🟢 Parámetros recibidos:', this.$route.params)
  ...
  methods: {
    ...
    mostrarMensaje(texto, tipo) {
      ...
      setTimeout(() => {
        this.mensaje = ''
        if (tipo === 'success') {
          this.$router.push({ name: 'ConfiguracionUsuarioView' })
        }
      }, 2000)
    },
