      ...
      <div class="picker-panel">
        ...
        <div class="calendars-header">
          ...
          <span
            ...
            @click="abrirSelectorMes('izquierdo')"
          >
          ...
          <span
            class="month-title clickable"
            @click="abrirSelectorMes('derecho')"
          >
        ...
        <div
          v-if="selectorMesVisible"
          class="selector-mes-overlay"
          @click.self="selectorMesVisible = false"
        >
          <div class="selector-mes-panel">
            <!-- Selector de año -->
            <div class="selector-anio-row">
              <button type="button" class="nav-btn" @click="selectorAnio--">
                &lt;
              </button>
        ...
        <div class="calendars-row">
          ...
          <div class="calendar">
            ...
            <div class="days-grid">
              <span
                v-for="(day, i) in diasMesIzquierdo"
                :key="'l-' + i"
        ...
        <p class="hint">
          Formato fecha: yyyy/MM/dd. Formato hora: HH:mm:ss (24h)
        </p>
...
export default {
  ...
  computed: {
    ...
    anioDerecho() {
      return this.mesIzquierdo === 11
        ? this.anioIzquierdo + 1
        : this.anioIzquierdo;
    },
    ...
    rangoValido() {
      return (
        this.fechaInicioSel &&
        this.fechaFinSel &&
        this.fechaInicioSel <= this.fechaFinSel
      );
    },
    ...
    displayRange() {
      ...
      const fi = this.formatDateTimeDisplay(
        this.fechaInicioSel,
        this.inputHoraInicio,
      );
      const ff = this.formatDateTimeDisplay(
        this.fechaFinSel,
        this.inputHoraFin,
      );
      return `${fi}  >  ${ff}`;
  ...
  methods: {
    ...
    aplicar() {
      ...
      const inicio =
        this.inputFechaInicio.replace(/\//g, "-") + "T" + this.inputHoraInicio;
      const fin =
        this.inputFechaFin.replace(/\//g, "-") + "T" + this.inputHoraFin;
